...
if(isset($_POST['renew_book']) && $_POST['renew_book'] != "" )
{
	 ...
	 $req->execute(array('firstname' => '%'.$_POST['renew_book'].'%','lastname'=>'%'.$_POST['renew_book'].'%','email'=>'%'.$_POST['renew_book'].'%','phone'=>'%'.$_POST['renew_book'].'%','unique_id'=>'%'.$_POST['renew_book'].'%'));
	 if($req -> rowCount()==0)
	 {
		?> 
