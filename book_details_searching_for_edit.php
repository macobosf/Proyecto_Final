		...
		while($data = $req ->fetch())
			...
			else
			{
			   $book_avai = "Unknow";	
		 		...
		 		?>
               <div class="line" style="width:379px; z-index:99999;" onclick="javascript:return book_edit_Details('<?PHP echo $id ?>','<?PHP echo  ucfirst($data['book_name']); ?>','<?PHP echo $data['author_name']; ?>','<?PHP echo $data['register_quantity']; ?>','<?PHP echo $book_avai; ?>','<?PHP echo $data['book_language']; ?>','<?PHP echo $data['book_price']; ?>','<?PHP echo $data['book_edition']; ?>','<?PHP echo $data['book_registration_time']; ?>','<?PHP echo $data['book_isbn_number'];?>')" title="Edition: &nbsp;<?PHP echo $data['book_edition']; ?>"> <div class="img_style">
             <img src="<?PHP echo $book_img_get; ?>" height="50" width="50" /></div><div class="search_details" style="width:288px;"><span style="font-size:14px; font-weight:bold;">&nbsp;&nbsp;<?PHP echo ucfirst($data['book_name']); ?></span>&nbsp;&nbsp;&nbsp;
                <span style="color:#666; font-size:12px;">by&nbsp;<?PHP  echo $data['author_name']; ?></span><div id="other_info">&nbsp;&nbsp;&nbsp;ISBN:&nbsp;<?PHP echo $data['book_isbn_number']; ?><br />&nbsp;&nbsp;&nbsp;Tiempo de registro:
