...
if(isset($_POST['Usersrh']) && $_POST['Usersrh'] != "" )
{
	 ...
	 {
		?> 
       <div class="line" style="text-align:center; width:379px;"><?PHP echo"<br/>No member found !!!"; ?></div>
        <?PHP 
	 }else
		{
		...
		/////
			...
			else
			{
               ...
               <div class="line" style="width:379px;" onclick="javascript:return mem_edit_Detail_show('<?PHP echo $data['unique_id']; ?>','<?PHP echo ucfirst($data['firstname']); ?>','<?PHP echo ucfirst($data['middlename']); ?>','<?PHP echo ucfirst($data['lastname']); ?>','<?PHP echo $data['faculty']; ?>','<?PHP echo $data['program']; ?>','<?PHP echo $data['semester']; ?>','<?PHP echo $data['batch']; ?>','<?PHP echo $data['gender']; ?>','<?PHP echo $data['dob'];?>','<?PHP echo $data['country']; ?>','<?PHP echo $data['district']; ?>','<?PHP echo $data['city']; ?>','<?PHP echo $data['phone'];?>','<?PHP echo $data['email'];?>','<?PHP echo $img_get;?>')" title="Member ID:<?PHP echo $data['unique_id']; ?>"> <div class="img_style">
...
&nbsp;&nbsp;&nbsp;Número de problema del libro:&nbsp;<span id="number_color" title="<?PHP for($j=0; $j<$book_count;$j++){ 
